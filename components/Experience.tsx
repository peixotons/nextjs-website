  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex items-center justify-center overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar h-[90%] scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#f7ab0a]/80">
        <article
          className="flex flex-col rounded-lg items-center space-y-3 md:space-y-7 flex-shrink-0 
    w-[270px] h-[450px] md:w-[700px] md:h-[600px] xl:h-[600px] snap-center bg-[#292929] p-5 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden"
        >
          <motion.img
            ...
            viewport={{ once: true }}
            className="w-32 h-32 rounded xl:w-[150px] xl:h-[150px] object-cover object-center"
