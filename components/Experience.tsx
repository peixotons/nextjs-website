...
export default function Experience({}: Props) {
  return (
    ...
    w-[270px] h-[450px] md:w-[700px] md:h-[450px] xl:h-[550px] snap-center bg-[#292929] p-5 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden"
        >
          <motion.img
